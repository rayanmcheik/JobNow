...
const Footer = () => {
  return (
    <footer className="w-full px-6 py-10 text-white bg-oceanColor mx-auto pt-56">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 md:gap-10 justify-between">
        <div className="flex flex-col justify-center items-start">
          ...
          <p className="mb-4 space-y-2 text-gray-100 pb-10 md:pb-0">
        ...
        <div className='hidden md:block md:w-auto md:ml-20'>
          <h3 className="mb-4 text-3xl font-bold font-poppins text-left">Pages</h3>
          <ul className="space-y-2 text-gray-100 text-left ">
 ...
 <div className='flex flex-row justify-between w-full md:hidden gap-10'>
   <div>
        ...
        <div>
          <h3 className="mb-4 text-3xl font-bold font-poppins pt-10 md:pt-0">Contact Us</h3>
