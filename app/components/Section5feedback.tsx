...
const Section5feedback = () => {
  ...
  const prevSlide = () => {
    setCurrentIndex((prev) => (prev === 0 ? feedbackImages.length - 1 : prev - 1));
  };

  const nextSlide = () => {
    setCurrentIndex((prev) => (prev === feedbackImages.length - 1 ? 0 : prev + 1));
  };
                ...
                <div className="flex flex-col justify-center w-full md:flex md:flex-row md:justify-between md:gap-5">
                    <div className="flex flex-col md:w-3/4">
                        <div className="flex flex-col md:flex md:flex-col md:justify-between">
                            ...
                            <div className="flex md:hidden w-[350px] h-[300px] pl-5 pr-20 text-center">
                                <img
